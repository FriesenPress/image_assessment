...
var YARDSTICK_DEFS = [0.5, 0.75, 1.0]; // IMAGE AS % OF ACTUAL TRIM SIZE
...
// This converts the AVAILABLE TRIM SIZES FROM INCHES TO PIXELS.
...
$(function() {
	...
	$( "#assess-image-button" ).on( 'click', function() {
		...
		if ($( "#radio input[type='radio']:checked" ).val() == 'image-from-file') {
